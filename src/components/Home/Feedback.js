...
const feedback = [
    {
        colonImg:colon,
        tagLine: " There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem.",
        feedbackerImg:boy,
...
const Feedback = () => {
    ...
    return (
        <Box>
            <Container className="container Feedback" sx={{ pt: 10 }}>
                <Box align="center" className="feedback_box" sx={{ pb: 6 }}>
                    ...
                    <Typography variant="h6" className="feedback_inner text_secondary font_poppins" sx={{ textAlign: "center", pt: 1 }}>
